...
cat('<div>')
cat('<p style="margin: 20px 0px; color: #666;">Revista <strong>', metadata$source, '</strong>Vol. ', metadata$source_volume, '(', metadata$source_issue, '), ', metadata$pages, '</p>')
...
cat('<footer>',
  ...
  '<p>', 
  paste(metadata$authors_name, collapse = ", "), ' (', substr(metadata$date_created, 1, 4), '). ', 
